...
export function createSidebarAppContext(isStandalone) {
  ...
  const dom = {
    ...
    multiRegenerateMenu: document.getElementById('multi-regenerate-menu'),
    multiRegenerate3Button: document.getElementById('multi-regenerate-3'),
    multiRegenerate5Button: document.getElementById('multi-regenerate-5'),
